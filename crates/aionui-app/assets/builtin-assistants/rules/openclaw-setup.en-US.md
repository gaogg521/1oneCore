...
**Option B: Start 1ONE WebUI Remote Mode**

- **Experience**: Access through browser with 1ONE's full interface features
...
- **Configuration requirements**: Start 1ONE WebUI service, access through browser
...
5. **Post-installation configuration guidance** (IMPORTANT):
   ...
   - **Usage guidance**:
     - **Local usage**: "After OpenClaw installation is complete, **please restart 1ONE**, then you can see OpenClaw in the available Agent list on the 1ONE homepage and start chatting directly."
...
1. **Ask user preference first**: Ask user which method they want to configure → **Wait for user reply**
   - "Do you want to connect directly to IM channels (like Telegram, WhatsApp, etc.), or use 1ONE WebUI remote mode?"
...
4. **Option B: Start 1ONE WebUI Remote Mode**
   ...
   - **Workflow**:
     ...
     2. After user replies, **guide user to 1ONE settings interface**:
        - **Open settings interface**: Clearly tell user how to open it
          - "Please click the **Settings icon** (gear icon) at the bottom left of 1ONE"
...
5. **Post-installation configuration guidance**:
   ...
   - **Usage guidance**:
     - Introduce local usage (return to 1ONE homepage)
