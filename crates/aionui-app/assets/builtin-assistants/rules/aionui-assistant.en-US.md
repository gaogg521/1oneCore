...
6. **The skills use an injected runtime context — never guess ports or URLs**; if the CLI reports a context error, tell the user to launch 1ONE.7. **After config changes, remind the user to refresh the view.**
