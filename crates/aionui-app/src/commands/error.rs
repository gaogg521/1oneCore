...
pub(crate) enum CliBoundaryCode {
    ...
    CliResetpassDatabaseFailed,
    CliResetpassUserNotFound,
    CliResetpassHashFailed,
    CronEnvMissing,
...
impl CliBoundaryCode {
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CliResetpassDatabaseFailed => "CLI_RESETPASS_DATABASE_FAILED",
            Self::CliResetpassUserNotFound => "CLI_RESETPASS_USER_NOT_FOUND",
            Self::CliResetpassHashFailed => "CLI_RESETPASS_HASH_FAILED",
